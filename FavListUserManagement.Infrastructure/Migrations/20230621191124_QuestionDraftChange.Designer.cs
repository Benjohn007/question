...
namespace FavListUserManagement.Infrastructure.Migrations
{
    ...
    [Migration("20230621191124_QuestionDraftChange")]
    partial class QuestionDraftChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FavListUserManagement.Domain.Entities.Category", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("FavListUserManagement.Domain.Entities.QuestionDraft", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("FavListUserManagement.Domain.Entities.PortalFeature", b =>
                {
                    b.HasOne("FavListUserManagement.Domain.Entities.Category", "Catergory_Id")
                        .WithMany()
            ...
            modelBuilder.Entity("FavListUserManagement.Domain.Entities.Question", b =>
                {
                    b.HasOne("FavListUserManagement.Domain.Entities.Category", "Catergory")
                        .WithMany("Question")
